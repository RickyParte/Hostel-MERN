...
export default function AdminSignIn() {
  ...
  const getHostel = async () => {
    ...
    try {
      const res = await fetch("http://3.111.139.9:5000/api/admin/get-hostel", {
        method: "POST",
        headers: {
  ...
  let login = async (event) => {
    ...
    let response = await fetch("http://3.111.139.9:5000/api/auth/login", {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
      },
    ...
    if (result.success) {
      ...
      let admin = await fetch("http://3.111.139.9:5000/api/admin/get-admin", {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
        },
